/** SmileyToggle is a custom smiley toggle switch that accepts short text and
...
function SmileyToggle({ data, changeScreen, isChecked }) {
    ...
    <div className="Toggle">
      <label className="flex items-center justify-center cursor-pointer">
        <div className="relative">
          ...
          <div className={`dot absolute left-0 top-0 bg-[url('/public/smiley.png')]
          bg-no-repeat bg-center bg-contain w-12 h-12 -mt-1 ml-1 rounded-full transition
          ${isChecked ? 'translate-x-10' : ''}`}></div>
        </div>
