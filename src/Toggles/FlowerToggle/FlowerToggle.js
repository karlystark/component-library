/** FlowerToggle is a custom flower toggle switch that accepts short text and
...
function FlowerToggle({ data, changeScreen, isChecked }) {
    ...
    <div className="Toggle">
      <label className="flex items-center justify-center cursor-pointer">
        <div className="relative">
          ...
          <div className={`dot absolute left-0 top-0 bg-[url('/public/flower.png')]
